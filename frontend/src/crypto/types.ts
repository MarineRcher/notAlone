...
export interface KeyPair {
  ...
  export interface GroupKeyDistribution {
    ...
    recipients: {                // Map of recipient ID to their encrypted key
  ...
  export interface EncryptionState {
    ...
    sessions: {                   // Map of user ID to session
      [userId: string]: Session;  
    };
    groupSessions: {              // Map of group ID to group session
  ...
  export interface EncryptionFunctions {
    ...
    encryptGroupMessage: (message: string, groupId: string) => Promise<EncryptedMessage>;
   ...
   */
  export interface EncryptionContextValue extends EncryptionState, EncryptionFunctions {}
