 ...
 */
router.post('/users/:userId/sessions', authenticateToken, async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
 ...
 */
router.get('/users/:userId/public-key', async (req: Request, res: Response): Promise<void> => {
  try {
    const { userId } = req.params;
 ...
 */
router.post('/group-messages', authenticateToken, async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
