...
import * as JwtServices from "../../../../services/JwtServices";
...
<<<<<<< HEAD:backend/tests/unit/controllers/user/notificationController.test.ts
	beforeEach(() => {
		jest.clearAllMocks();
	});
=======
    beforeEach(() => {
        jest.clearAllMocks();
    jest.spyOn(JwtServices, "generateToken").mockReturnValue("mocked-token");

    });
>>>>>>> mar/typing-tests:backend/src/tests/unit/controllers/user/notificationController.test.ts
