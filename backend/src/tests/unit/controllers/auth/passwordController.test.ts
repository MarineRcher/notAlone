...
import * as isPasswordCompromisedModule from "../../../../utils/auth/isPasswordCompromised";

// Mocks
jest.mock("bcryptjs");
jest.mock("../../../../models/User");
jest.mock("../../../../config/logger");
jest.mock("../../../../utils/auth/isPasswordCompromised");
...
describe("Password Controller", () => {
	...
	describe("Password change authentication", () => {
		...
		test("should reject compromised passwords", async () => {
			...
			(User.findOne as jest.Mock).mockResolvedValue(mockUser);
			(bcrypt.compare as jest.Mock).mockResolvedValue(true);
			(isPasswordCompromisedModule.default as jest.Mock).mockResolvedValue(
				true,
			);
