...
const mockSafeRedisClient = safeRedisClient as jest.Mocked<typeof safeRedisClient>;
  ...
  describe('when Redis is enabled (production)', () => {
    ...
    describe('cacheGroupInfo', () => {
      ...
      it('should handle caching errors gracefully', async () => {
        ...
        // Should not throw
        await expect(redisService.cacheGroupInfo('test-group', groupInfo))
    ...
    describe('getCachedGroupInfo', () => {
      it('should retrieve cached group information', async () => {
        ...
        expect(mockSafeRedisClient.get).toHaveBeenCalledWith('group:test-group');
    ...
    describe('clearGroupCache', () => {
      it('should clear group cache', async () => {
        ...
        expect(mockSafeRedisClient.del).toHaveBeenCalledWith('group:test-group');
      });
      ...
      it('should handle deletion errors gracefully', async () => {
        ...
        // Should not throw
        await expect(redisService.clearGroupCache('test-group'))
          .resolves.toBeUndefined();
      });
    });
